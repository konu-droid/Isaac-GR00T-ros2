...
BAG_FILE_PATH = '/home/konu/Documents/groot/ros2bags/so100_no_move'
# Where to save the formatted dataset
OUTPUT_DATASET_DIR = './my_robot_groot_lerobot_dataset' # Changed output dir name slightly
...
TASKS_DATA = [
    {"task_index": 0, "task": "PLACEHOLDER: Describe the primary task."},
    {"task_index": 1, "task": "PLACEHOLDER: Describe another condition/annotation."},
]
...
class DatasetFormatter:
    ...
    def _write_metadata(self, total_frames: int, total_episodes: int, fps: float, video_info: Dict):
        ...
        with jsonlines.open(episodes_file, mode='w') as writer:
            writer.write({ "episode_index": 0, "tasks": [data['task_index'] for data in TASKS_DATA], "length": total_frames })
